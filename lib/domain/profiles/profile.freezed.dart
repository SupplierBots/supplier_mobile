...
class _$ProfileCopyWithImpl<$Res> implements $ProfileCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      addressDetails: addressDetails == freezed
      ...
      creditCardNumber: creditCardNumber == freezed
          ? _value.creditCardNumber
          : creditCardNumber as String,
      expiryMonth:
          expiryMonth == freezed ? _value.expiryMonth : expiryMonth as String,
      expiryYear:
          expiryYear == freezed ? _value.expiryYear : expiryYear as String,
      securityCode: securityCode == freezed
          ? _value.securityCode
...
class _$_Profile extends _Profile {
    ...
    return identical(this, other) ||
        (other is _Profile &&
            ...
            (identical(other.securityCode, securityCode) ||
                const DeepCollectionEquality()
                    .equals(other.securityCode, securityCode)));
  }
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(securityCode);
...
abstract class _Profile extends Profile {
  ...
  const factory _Profile(
      ...
      @required String expiryMonth,
      @required String expiryYear,
      @required String securityCode}) = _$_Profile;
