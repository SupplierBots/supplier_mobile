...
class _$_Task implements _Task {
  ...
  @override
  String toString() {
    return 'Task(product: $product, profileName: $profileName, size: $size, anyColor: $anyColor, anySize: $anySize, colors: $colors, anySizeOption: $anySizeOption)';
  }
