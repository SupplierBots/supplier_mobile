...
class PurchaseProfile extends StatefulWidget {
  @override
  _PurchaseProfileState createState() => _PurchaseProfileState();
}

class _PurchaseProfileState extends State<PurchaseProfile> {
